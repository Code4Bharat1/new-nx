  ...
  return (
    <div className="relative pt-[94px] h-[calc(100vh-4rem)] sm:h-[60vh] overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 right-1/3 w-3 h-3 bg-cyan-400 rounded-full opacity-40 animate-pulse delay-300"></div>
      ...
      <div className="relative z-10 flex flex-col h-full w-full justify-center items-center sm:justify-between sm:flex-row px-6 sm:px-[11.5rem] gap-6">
        ...
        <div className="flex flex-col items-center sm:items-start">
          {/* Decorative Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-4 py-2 rounded-full text-xs font-bold mb-4 shadow-lg animate-pulse">
          ...
          <p className="text-gray-300 text-sm sm:text-base text-center sm:text-left max-w-md drop-shadow-lg">
            Complete warehouse management and inventory control
          </p>
          
          {/* Decorative Line */}
          <div className="mt-4 w-24 h-1 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-full"></div>
        </div>
        ...
        <div className="flex flex-col items-center sm:items-end gap-4">
          ...
          <div className="flex flex-wrap justify-center sm:justify-end items-center gap-2 text-sm sm:text-base font-semibold bg-black/40 backdrop-blur-md px-6 py-3 rounded-full border border-white/20 shadow-xl">
            ...
            <ChevronRight className="w-4 h-4 text-[#E1306C]" />
            <span className="text-white font-bold">Odoo Inventory</span>
          </div>

          {/* Call to Action Buttons */}
          <div className="flex gap-3">
            <button className="bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white px-6 py-2.5 rounded-full font-semibold text-sm shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              Get Started
            </button>
