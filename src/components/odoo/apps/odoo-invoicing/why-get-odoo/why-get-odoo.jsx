...
import { Zap, Shield, TrendingUp, FileText, RefreshCw, FileCheck, Sparkles, CheckCircle, ArrowRight } from "lucide-react";

const Whyget = () => {
  const features = [
    { icon: <Zap className="w-5 h-5" />, text: "Fast and secure payments", color: "from-blue-500 to-cyan-500" },
    { icon: <RefreshCw className="w-5 h-5" />, text: "Online transactions with automated follow-ups", color: "from-purple-500 to-pink-500" },
    { icon: <TrendingUp className="w-5 h-5" />, text: "Insightful analysis", color: "from-green-500 to-emerald-500" },
    { icon: <FileText className="w-5 h-5" />, text: "Easy conversion of quotes into invoices", color: "from-orange-500 to-red-500" },
    { icon: <RefreshCw className="w-5 h-5" />, text: "Recurring invoices creation", color: "from-indigo-500 to-purple-500" },
    { icon: <FileCheck className="w-5 h-5" />, text: "Contract management", color: "from-teal-500 to-cyan-500" }
  ];

  return (
    <section className="relative bg-gradient-to-br from-gray-50 via-white to-purple-50 py-16 sm:py-20 overflow-hidden">
      {/* Decorative Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-20 w-96 h-96 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full opacity-20 blur-3xl animate-pulse"></div>
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:pl-[12rem] lg:pr-[11rem] grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-20 relative z-10">
        ...
        <div className="relative flex justify-center group">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 rounded-3xl opacity-0 group-hover:opacity-20 blur-2xl transition-all duration-500"></div>
          ...
          <div className="relative transform transition-all duration-500 group-hover:scale-105">
            ...
            <div className="shadow-2xl p-3 bg-white rounded-2xl border-4 border-white group-hover:shadow-purple-500/30 transition-all duration-500">
              <img
        ...
        <div className="text-center sm:text-left space-y-6">
          {/* Premium Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-5 py-2 rounded-full text-xs font-bold uppercase tracking-wider shadow-lg">
            <Sparkles className="w-4 h-4" />
            <span>Essential Solution</span>
          </div>

          {/* Main Heading */}
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight">
            <span className="text-gray-900">Why get </span>
            <span className="bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 bg-clip-text text-transparent">
              Odoo Invoicing
            </span>
            <span className="text-gray-900"> implemented?</span>
          </h2>
          ...
          {/* CTA Button */}
          {/* <div className="pt-0">
            <button className="group bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 hover:from-purple-700 hover:via-pink-700 hover:to-blue-700 text-white px-8 py-4 rounded-full font-bold text-base shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-purple-500/50 flex items-center gap-1 mx-auto sm:mx-0">
