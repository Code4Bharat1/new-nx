      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-[10rem] grid grid-cols-1 lg:grid-cols-2 gap-[3rem] items-center">
        ...
        <div className="text-left">
          <p className="text-purple-700 text-sm sm:text-[17px] font-semibold uppercase tracking-wider mb-2">
           Automate the Marketing Actions Of Your Business
          </p>
          <h1 className="text-2xl sm:text-[20px] font-extrabold text-gray-800 mb-6 leading-snug">
           Targeted Marketing Campaigns with Odoo Marketing Automation
          </h1>
          <h2 className="text-base sm:text-[24px] font-[1000] text-gray-900 mb-4">
           Sales Funnel Optimisation with Odoo Marketing Automation Software
          </h2>
          <p className="text-gray-500 text-sm sm:text-base mb-4 leading-relaxed tracking-wide text-justify">
           Odoo Marketing Automation module enables businesses to run targeted marketing campaigns automatically. At odoo Implementers, we assist you in the customization and integration of the Odoo marketing automation software with your current business modules to help you mechanize the marketing actions and create end-end user journeys. Our experts will guide you in each step of Odoo Marketing automation implementation and make the most of it.
          </p>
        </div>
        ...
        <div className="relative">
          <img
            src="/images/App images/odoo-marketing-automation-software-sales-optimization.gif"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
          <div className="relative bg-white rounded-lg overflow-hidden w-full max-w-4xl">
            ...
            <iframe
              width="100%"
              height="500"
              src="https://www.youtube.com/embed/BJXmLEUoXZA?si=rcsvLrXf54MpRF00"
